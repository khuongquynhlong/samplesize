        ...
        tabItem(
            ...
            fluidRow(
                myBox(width = 12, background = "#222d32",color = "white",
                    ...
                    #tags$br(),
                    p(HTML("<center> <p style='font-size:14px;color:white;'> Trường Đại học Y tế công cộng (HUPH)</sup> </p> </center>")),
                    p(HTML("<center> <p style='font-size:14px;color:white;'> Mạng lưới Nghiên cứu Khoa học Sức khỏe Việt Nam (ADHERE)</sup> </p> </center>")),
                    ...
                    p(HTML("<center> <b> <p style='font-size:12px;color:white;'> </b> <i>  Tác giả: Khương Quỳnh Long, Ong Phúc Thịnh, Hoàng Văn Minh </i> </p>  </center>")),
                    #tags$br(),
