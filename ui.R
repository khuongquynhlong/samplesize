        ...
        tabItem(
            ...
            fluidRow(
                myBox(width = 12, background = "#222d32",color = "white",
                    ...
                    p(HTML("<center> <p style='font-size:15px;color:white;'> Mạng lưới Nghiên cứu Khoa học Sức khỏe Việt Nam (ADHERE) </p> </center>")),
                    p(HTML("")),
...
dashboardPage(title = "Phần mềm HSS 1.0",
    dashboardHeader(
        title = span(HTML("Phần mềm HSS 1.0")),
        tags$li(
