        ...
        tabItem(
            ...
            fluidRow(
                myBox(width = 12, background = "#222d32",color = "white",
                    ...
                    #tags$br(),
                    p(HTML("<center> <p style='font-size:16px;color:white;'> Trường Đại học Y tế công cộng (HUPH)</sup> </p> </center>")),
                    p(HTML("<center> <p style='font-size:16px;color:white;'> Mạng lưới Nghiên cứu Khoa học Sức khỏe Việt Nam (ADHERE)</sup> </p> </center>")),
                    tags$br(),
