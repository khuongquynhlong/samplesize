                        ...
                        box(title = "Tính cỡ mẫu", width = 6,
                            box(
                                textInput(inputId = "alpha_1prop_est",
                                          ...
                                          value = 0.05),
                                p(uiOutput(outputId = "za_1prop_est")),
                        ...
                        box(title = "Tính cỡ mẫu", width = 6,
                            box(
                                textInput(inputId = "alpha_1mean_est",
                                          label = HTML("Alpha (&alpha;)"),
                                          value = 0.05),
                                p(uiOutput(outputId = "za_1mean_est")),
                        ...
                        box(title = "Tính cỡ mẫu", width = 6,
                            box(
                                textInput(inputId = "alpha_2means_ind_est",
                                          label = HTML("Alpha (&alpha;)"),
                                          value = 0.05),
                                p(uiOutput(outputId = "za_2means_ind_est")),
                        ...
                        box(title = "Tính cỡ mẫu", width = 6,
                            box(
                                textInput(inputId = "alpha_2props_pair_est",
                                          label = HTML("Alpha (&alpha;)"),
                                          value = 0.05),
                                p(uiOutput(outputId = "za_2props_pair_est")),
                        ...
                        box(title = "Tính cỡ mẫu", width = 6,
                            box(
                                textInput(inputId = "alpha_2props_est",
                                          label = HTML("Alpha (&alpha;)"),
                                          value = 0.05),
                                p(uiOutput(outputId = "za_2props_est")),
                                ...
                                fluidRow(
                                    box(
                                        textInput(inputId = "alpha_1mean_hypo",
                                                  label = HTML("Alpha (&alpha;)"),
                                                  value = 0.05),
                                        p(uiOutput(outputId = "za_1mean_hypo")),
                                        textInput(inputId = "power_1mean_hypo",
                                                  label = HTML("Lực thống kê (1-&beta;)"),
                                                  value = 0.8),
                                        p(uiOutput(outputId = "zb_1mean_hypo")),
                                ...
                                fluidRow(
                                    ...
                                    box(
                                        textInput(inputId = "alpha_1mean_hypo_power",
                                                  label = HTML("Alpha (&alpha;)"),
                                                  value = 0.05),
                                        p(uiOutput(outputId = "za_1mean_hypo_power")),
                                ...
                                fluidRow(
                                    box(
                                        textInput(inputId = "alpha_1prop_hypo",
                                                  label = HTML("Alpha (&alpha;)"),
                                                  value = 0.05),
                                        p(uiOutput(outputId = "za_1prop_hypo")),
                                ...
                                fluidRow(
                                    ...
                                    box(
                                        textInput(inputId = "alpha_1prop_hypo_power",
                                                  label = HTML("Alpha (&alpha;)"),
                                                  value = 0.05),
                                        p(uiOutput(outputId = "za_1prop_hypo_power")),
                                ...
                                fluidRow(
                                    box(
                                        textInput(inputId = "alpha_2means_ind_hypo",
                                                  label = HTML("Alpha (&alpha;)"),
                                                  value = 0.05),
                                        p(uiOutput(outputId = "za_2means_ind_hypo")),
                                        textInput(inputId = "power_2means_ind_hypo",
                                                  label = HTML("Lực thống kê (1-&beta;)"),
                                                  value = 0.8),
                                        p(uiOutput(outputId = "zb_2means_ind_hypo")),
                                ...
                                fluidRow(
                                    ...
                                    box(
                                        ...
                                        textInput(inputId = "alpha_2means_ind_hypo_power",
                                                  label = HTML("Alpha (&alpha;)"),
                                                  value = 0.05),
                                        p(uiOutput(outputId = "za_2means_ind_hypo_power"))
                                    ),
                                    myBox(background = "#d9d9d9",color = "black",
                                        p(HTML("<center><b>Lực thống kê</b></center>")),
                                ...
                                fluidRow(
                                    box(
                                        textInput(inputId = "alpha_2means_pair_hypo",
                                                  label = HTML("Alpha (&alpha;)"),
                                                  value = 0.05),
                                        p(uiOutput(outputId = "za_2means_pair_hypo")),
                                        textInput(inputId = "power_2means_pair_hypo",
                                                  label = HTML("Lực thống kê (1-&beta;)"),
                                                  value = 0.8),
                                        p(uiOutput(outputId = "zb_2means_pair_hypo")),
                                ...
                                fluidRow(
                                    ...
                                    box(
                                        ...
                                        textInput(inputId = "alpha_2means_pair_hypo_power",
                                                  label = HTML("Alpha (&alpha;)"),
                                                  value = 0.05),
                                        p(uiOutput(outputId = "za_2means_pair_hypo_power"))
                                    ),
                                    myBox(background = "#d9d9d9",color = "black",
                                        p(HTML("<center><b>Lực thống kê</b></center>")),
                                ...
                                fluidRow(
                                    box(
                                        textInput(inputId = "alpha_2props_ind_hypo",
                                                  label = HTML("Alpha (&alpha;)"),
                                                  value = 0.05),
                                        p(uiOutput(outputId = "za_2props_ind_hypo")),
                                        textInput(inputId = "power_2props_ind_hypo",
                                                  label = HTML("Lực thống kê (1-&beta;)"),
                                                  value = 0.8),
                                        p(uiOutput(outputId = "zb_2props_ind_hypo")),
                                ...
                                fluidRow(
                                    ...
                                    box(
                                        textInput(inputId = "alpha_2props_ind_hypo_power",
                                                  label = HTML("Alpha (&alpha;)"),
                                                  value = 0.05),
                                        p(uiOutput(outputId = "za_2props_ind_hypo_power")),
                                ...
                                fluidRow(
                                    box(
                                        textInput(inputId = "alpha_cohort_hypo",
                                                  label = HTML("Alpha (&alpha;)"),
                                                  value = 0.05),
                                        p(uiOutput(outputId = "za_cohort_hypo")),
                                        textInput(inputId = "power_cohort_hypo",
                                                  label = HTML("Lực thống kê (1-&beta;)"),
                                                  value = 0.8),
                                        p(uiOutput(outputId = "zb_cohort_hypo")),
                                ...
                                fluidRow(
                                    ...
                                    box(
                                        textInput(inputId = "alpha_cohort_hypo_power",
                                                  label = HTML("Alpha (&alpha;)"),
                                                  value = 0.05),
                                        p(uiOutput(outputId = "za_cohort_hypo_power")),
                                ...
                                fluidRow(
                                    ...
                                    box(
                                        textInput(inputId = "alpha_case_hypo_power",
                                                  label = HTML("Alpha (&alpha;)"),
                                                  value = 0.05),
                                        p(uiOutput(outputId = "za_case_hypo_power")),
                            ...
                            tabPanel(
                                ...
                                fluidRow(
                                    box(
                                        ...
                                        p(uiOutput(outputId = "select_survive")),
                                        textInput(inputId = "alpha_survive",
                                                  label = HTML("Alpha (&alpha;)"),
                                                  value = 0.05),
                                        p(uiOutput(outputId = "za_survive")),
                                        textInput(inputId = "power_survive",
                                                  label = HTML("Lực thống kê (1-&beta;)"),
                                                  value = 0.8),
                                        p(uiOutput(outputId = "zb_survive"))
                                    ),
                                    box(
                                ...
                                fluidRow(
                                    ...
                                    box(
                                        textInput(inputId = "alpha_survive_power",
                                                  label = HTML("Alpha (&alpha;)"),
                                                  value = 0.05),
                                        p(uiOutput(outputId = "za_survive_power")),
                                ...
                                fluidRow(
                                    box(
                                        textInput(inputId = "alpha_equi_cont",
                                                  label = HTML("Alpha (&alpha;)"),
                                                  value = 0.05),
                                        p(uiOutput(outputId = "za_equi_cont")),
                                ...
                                fluidRow(
                                    box(
                                        textInput(inputId = "alpha_equi_cat",
                                                  label = HTML("Alpha (&alpha;)"),
                                                  value = 0.05),
                                        p(uiOutput(outputId = "za_equi_cat")),
                                        textInput(inputId = "power_equi_cat",
                                                  label = HTML("Lực thống kê (1-&beta;)"),
                                                  value = 0.8),
                                        p(uiOutput(outputId = "zb_equi_cat")),
                                ...
                                fluidRow(
                                    ...
                                    box(
                                        textInput(inputId = "alpha_equi_cat_power",
                                                  label = HTML("Alpha (&alpha;)"),
                                                  value = 0.05),
                                        p(uiOutput(outputId = "za_equi_cat_power")),
                                ...
                                fluidRow(
                                    box(
                                        textInput(inputId = "alpha_noninfer_cont",
                                                  label = HTML("Alpha (&alpha;)"),
                                                  value = 0.05),
                                        p(uiOutput(outputId = "za_noninfer_cont")),
                                ...
                                fluidRow(
                                    box(
                                        textInput(inputId = "alpha_noninfer_cat",
                                                  label = HTML("Alpha (&alpha;)"),
                                                  value = 0.05),
                                        p(uiOutput(outputId = "za_noninfer_cat")),
                                        textInput(inputId = "power_noninfer_cat",
                                                  label = HTML("Lực thống kê (1-&beta;)"),
                                                  value = 0.8),
                                        p(uiOutput(outputId = "zb_noninfer_cat")),
                                ...
                                fluidRow(
                                    box(
                                        ...
                                        textInput(inputId = "alpha_cluster_randomize",
                                                  label = HTML("Alpha (&alpha;)"),
                                                  value = 0.05),
                                        p(uiOutput(outputId = "za_cluster_randomize")),
                                        textInput(inputId = "power_cluster_randomize",
                                                  label = HTML("Lực thống kê (1-&beta;)"),
                                                  value = 0.8),
                                        p(uiOutput(outputId = "zb_cluster_randomize")),
        ...
        tabItem(
            ...
            fluidRow(
                myBox(width = 12, background = "#222d32",color = "white",
                    ...
                    #tags$br(),
                    p(HTML("<center> <p style='font-size:20px;color:white;'> Trường Đại học Y tế công cộng (HUPH)</sup> </p> </center>")),
                    p(HTML("<center> <p style='font-size:20px;color:white;'> Mạng lưới Nghiên cứu Khoa học Sức khỏe Việt Nam (ADHERE)</sup> </p> </center>")),
                    tags$br(),
                    p(HTML("<center> <b> <p style='font-size:28px;color:white;'> TÍNH TOÁN CỠ MẪU TRONG CÁC NGHIÊN CỨU KHOA HỌC SỨC KHỎE </sup> </p> </b> </center>")),
                    p(HTML("<center> <b> <p style='font-size:28px;color:white;'> (HEALTH STUDY SIZE -  HSS 1.0) </p> </b> </center>")),
                    ...
                    tags$br(),
                    p(HTML('<center><img src="Sampling2.gif" style="width:500px;"></center>')),
                    #tags$br(),
                    #tags$br(),
                    tags$br(),
